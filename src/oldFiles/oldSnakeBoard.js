// This Snakeboard does not use any redux it is pure react
...
function SnakeBoard() {
  ...
  useEffect(() => {
    async function getHighScore() {
      ...
      let maxScore = snakeData.reduce((a,b) => (a.score > b.score) ? a.score : b.score, 0);
  ...
  return (
    ...
    >
      ...
      ? <div className="game-over" data-testid="game-over">Game Over 
          <p className="high-score" data-testid="highscore-end">
      ...
      : <div className="new-game" data-testid="new-game">New Game 
          <p className="high-score" data-testid="highscore-start">
